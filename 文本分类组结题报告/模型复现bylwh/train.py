...
tf.flags.DEFINE_integer("batch_size", 22, "Batch Size (default: 44)")
...
with tf.Session() as sess:
    ...
    def dev_step(x_batch, y_batch, writer=None):
        ...
        step, summaries, cost, accuracy , one_alpha, two_alpha , out = sess.run([global_step, dev_summary_op, loss, acc,han.one_alpha, han.two_alpha, han.out], feed_dict)
    ...
    for epoch in range(FLAGS.num_epochs):
        ...
        for i in range(0, 4480, FLAGS.batch_size):
